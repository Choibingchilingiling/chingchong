...
DESCRIPTION:
This module simulates a high-frequency avionics sensor bus
(MIL-STD-1553/ARINC 429). It polls hardware peripherals concurrently,
formats telemetry buffers, and executes downstream signal normalization
